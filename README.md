...
│   │   ├── uploads.py                   # Document & AI processing routes
│   │   └── profile.py                   # User profile management
│   │
│   ├── services/
│   │   ├── text_extractor.py           # PyMuPDF + OpenCV + Tesseract
│   │   ├── gemini_preprocessor.py      # Gemini 2.0 Flash integration
│   │   ├── summarizer.py               # spaCy-based summarization
│   │   ├── quiz_service.py             # T5 + RoBERTa quiz generation
│   │   ├── mindmap_service.py          # KeyBERT + spaCy visualization
...
│   │   │   ├── MyNotes.jsx             # Document management
│   │   │   ├── SummaryPage.jsx         # Summary display
│   │   │   ├── QuizPage.jsx            # Quiz taking interface
│   │   │   ├── MindMapPage.jsx         # Canvas-based mind map viewer
│   │   │   ├── ProfilePage.jsx         # Profile editor
│   │   │   └── DownloadsPage.jsx       # Content downloads
│   │   │
